...
from models.wrappers.SegmentationModel import SegmentationModel
from models.heads.SegmentationHead import SegmentationHead
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        if not decoder_channels:
            decoder_channels = self.encoder.out_channels[1:][::-1]
